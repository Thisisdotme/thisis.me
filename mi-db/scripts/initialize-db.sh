...
#
curl -X PUT -d '{"password":"mi","fullname":"Howard Burrows","email":"howard@mobileidentity.me"}' -H "Content-Type: application/json; charset=utf-8" api.thisis.me/v1/authors/howard
...
#
curl -X PUT -d '{"password":"mi","fullname":"Loree Hirschman","email":"loree@mobileidentity.me"}' -H "Content-Type: application/json; charset=utf-8" api.thisis.me/v1/authors/howard
