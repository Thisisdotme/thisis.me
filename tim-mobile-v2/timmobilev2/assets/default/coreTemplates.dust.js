...
(function(){dust.register("_follow",body_0);function body_0(chk,ctx){return chk.section(ctx.get("content"),ctx,{"block":body_1},null).partial("_eventFooter",ctx);}function body_1(chk,ctx){return chk.write("<div class=\"content follow\">").exists(ctx.get("photo_url"),ctx,{"else":body_2,"block":body_3},null).write("<div class=\"inner-text\">").exists(ctx.get("label"),ctx,{"block":body_4},null).exists(ctx.get("data"),ctx,{"block":body_5},null).write("</div></div>");}function body_2(chk,ctx){return chk;}function body_3(chk,ctx){return chk.write("<div class=\"inner-image\"><img src='").reference(ctx.get("photo_url"),ctx,"h").write("' /></div>");}function body_4(chk,ctx){return chk.write("<p>").reference(ctx.get("label"),ctx,"h").write("</p>");}function body_5(chk,ctx){return chk.write("<p>").reference(ctx.get("data"),ctx,"h").write("</p>");}return body_0;})();
