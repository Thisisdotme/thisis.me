...
(function(){dust.register("_eventFooter",body_0);function body_0(chk,ctx){return chk.write("<footer><div class=\"avatar\"><div class=\"frame\"><img src=\"").reference(ctx.getPath(false,["author","picture","image_url"]),ctx,"h").write("\"/></div></div><div class=\"author\"><a href=\"/").reference(ctx.getPath(false,["author","name"]),ctx,"h").write("/#timeline\">").reference(ctx.getPath(false,["author","full_name"]),ctx,"h").write("</a></div>\t\t  <div class=\"main-text\">").exists(ctx.get("tagline"),ctx,{"block":body_1},null).write("</div><div><!-- loop through sources -->").exists(ctx.getPath(false,["origin","known"]),ctx,{"block":body_4},null).write("<span class=\"time-and-location\">").reference(ctx.get("time_ago"),ctx,"h").write(" ").reference(ctx.getPath(false,["location","name"]),ctx,"h").write("</span></div></footer>");}function body_1(chk,ctx){return chk.helper("truncate",ctx,{"block":body_2},{"value":body_3,"length":"50"});}function body_2(chk,ctx){return chk;}function body_3(chk,ctx){return chk.reference(ctx.get("tagline"),ctx,"h");}function body_4(chk,ctx){return chk.write(" ").exists(ctx.getPath(false,["origin","known","service_name"]),ctx,{"block":body_5},null);}function body_5(chk,ctx){return chk.write("<span class=\"service-icon ").reference(ctx.getPath(false,["origin","known","service_name"]),ctx,"h").write("\"></span>");}return body_0;})();
...
(function(){dust.register("_follow",body_0);function body_0(chk,ctx){return chk.write(" <div class=\"content\">").exists(ctx.get("photo"),ctx,{"else":body_1,"block":body_2},null).write("<div class=\"inner-text\">").exists(ctx.get("headline"),ctx,{"block":body_3},null).exists(ctx.get("content"),ctx,{"block":body_4},null).write("</div></div>").partial("_eventFooter",ctx);}function body_1(chk,ctx){return chk;}function body_2(chk,ctx){return chk.write("<div class=\"inner-image\"><img src='").reference(ctx.getPath(false,["photo","image_url"]),ctx,"h").write("' /></div>");}function body_3(chk,ctx){return chk.write("<p>").reference(ctx.get("headline"),ctx,"h").write("</p>");}function body_4(chk,ctx){return chk.write("<p>").reference(ctx.get("content"),ctx,"h").write("</p>");}return body_0;})();

//the author list for the index page
(function(){dust.register("authorList",body_0);function body_0(chk,ctx){return chk.write("<div id=\"index-content\" data-role=\"content\"><ul>").section(ctx.get("authors"),ctx,{"block":body_1},null).write("</ul></div><!-- /content -->");}function body_1(chk,ctx){return chk.write("<li><a href=\"").reference(ctx.get("author_name"),ctx,"h").write("\"><img src=\"/").reference(ctx.get("author_name"),ctx,"h").write("/asset/profile_thumb.jpg\"/><span>").reference(ctx.get("full_name"),ctx,"h").write("</span></a></li>");}return body_0;})();
